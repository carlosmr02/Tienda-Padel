...
import imgLogo from '../assets/villafranca.png';

function Footer() {
  return (

    <div className="text-center text-lg-start footer--bg__verde footer--border text-light">
          ...
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 ml-0 mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <img src={imgLogo} alt="" width="200" height="140" />
              </h6>
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mr-5 mb-4">
              ...
              <p>
                <a href="https://angular.io/" className="text-reset text-decoration-none">Palas</a>
              </p>
              <p>
                <a href="https://es.reactjs.org/" className="text-reset text-decoration-none">Ropa</a>
              </p>
              <p>
                <a href="https://vuejs.org/" className="text-reset text-decoration-none">Accesorios</a>
              </p>
            </div>
      ...
      <div className="text-center p-4">
        <p>
          © 2023 Copyright:
          <a className="text-reset text-decoration-none" href="#">Ultimate Padel</a>
        </p>
      </div>
    </div>
  );
